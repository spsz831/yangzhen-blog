                            ...
                            <div className={`prose prose-sm max-w-none dark:prose-invert ${previewMode === 'split' ? 'h-96 overflow-y-auto' : ''}`}>
                              <ReactMarkdown
                                ...
                                components={{
                                  ...
                                  ul: ({children}) => <ul className="list-disc list-inside mb-3 text-gray-700 dark:text-gray-300 text-sm">{children}</ul>,
                                  ol: ({children}) => <ol className="list-decimal list-inside mb-3 text-gray-700 dark:text-gray-300 text-sm">{children}</ol>,
                                  li: ({children}) => <li className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">{children}</li>,
